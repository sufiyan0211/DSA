...
===
<div class="_1l1MA" data-track-load="qd_description_content"><p>Given two strings <code>s</code> and <code>t</code>, return <em>the number of distinct</em> <span data-keyword="subsequence-string" class=" cursor-pointer relative text-dark-blue-s text-sm"><div class="popover-wrapper inline-block" data-headlessui-state=""><div><div id="headlessui-popover-button-:r99:" aria-expanded="false" data-headlessui-state=""><strong><em>subsequences</em></strong></div></div></div></span><em> of </em><code>s</code><em> which equals </em><code>t</code>.</p>
